...
def parse_arguments():
    ...
    parser.add_argument("--ssl-cert-path",      "--ssl_cert_path",      type=str, default=os.getenv("SSL_CERT_PATH"), help="Semi-colon (or comma) separated list of trusted SSL certificate file pathnames. If not provided, defaults to the system certificates.")
